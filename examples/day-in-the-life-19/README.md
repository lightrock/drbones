...
```text
examples/day-in-the-life-N/README.md
examples/README.md index entry
AGENTS.md trigger-map entry
```

The checker enforces this relationship. If a new `examples/day-in-the-life-N/README.md` exists but is not linked from both `examples/README.md` and `AGENTS.md`, the day-in-the-life indexing test should fail.
...
- repair a failed check saying an example is missing from `AGENTS.md` or `examples/README.md`
...
→ add the AGENTS.md trigger-map entry
...
- Inspect `examples/README.md` and `AGENTS.md`.
...
```text
1. Create examples/day-in-the-life-N/README.md.
2. Add a one-line entry to examples/README.md.
3. Add a trigger-map entry to AGENTS.md.
...
The `AGENTS.md` trigger map should answer:
...
```text
- [`day-in-the-life-N/`](day-in-the-life-N/README.md) — one plain-language sentence explaining the workflow pattern.
```
...
```text
examples/day-in-the-life-N/README.md exists
but AGENTS.md does not mention Day N or the path
```
...
```text
examples/day-in-the-life-N/README.md exists
but examples/README.md does not link day-in-the-life-N/README.md
```
