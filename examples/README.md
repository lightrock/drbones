...
- [`day-in-the-life-17/`](day-in-the-life-17/README.md) — a failed-test repair loop: a human pastes exact failed check output, and the foreground AI classifies the failure, fixes the smallest real cause, reruns the same check.
